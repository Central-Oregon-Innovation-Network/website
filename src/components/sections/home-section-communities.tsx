...
export default function HomeSectionCommunities() {
  return (
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              >
                Regardless of your passion, disposition, or focus area, Central Oregon has a community for you! Our communities are built on innovation in every way, and give you a clear path to get involved and grow your network... Check them out and join us today.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Image
              ...
              alt="Diverse tech community networking and collaborating"
