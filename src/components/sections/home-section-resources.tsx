...
export default function HomeSectionResources() {
  return (
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              >
                Building startups, the Central Oregon way...
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Central Oregon is a unique community built on a culture of growth and innovation. Whatever industry you're in or product you're building, we've got your back! Click below to join our community and find your tribe.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Image
              ...
              alt="Startup resources and tools for entrepreneurs"
